    ...
    private const CONTENT = [
        ...
        'service-articles' => [
            [
                ...
                <p>Сервис заказа такси «МИРА» предлагает быстро и недорого заказать машину "Газель" с грузчиками. Грузчики сервиса такси «МИРА» — настоящие профессионалы — всегда трезвые, 
                опытные, вежливые и заботливые к Вашим вещам. Компания несёт полную материальную ответственность за быстрый и безопасный переезд груза любого размера 
                в неограниченном количестве! Услуга грузового такси с грузчиками подтверждается документальным сопровождением.</p>
                 <h6>Транспорт:</h6>
                 <p>Для переезда предоставим Газель всех возможных габаритов.</p>
